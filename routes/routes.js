...
// const requireSignin = require('../controllers/authControllers.requireSignin')
...
router.get("/priceRules", authControllers.requireSignin, priceRulesControllers.priceRulesList)
router.get("/priceRules/filterTop", authControllers.requireSignin, priceRulesControllers.priceRulesFilterTop)
router.get("/priceRules/:id", authControllers.requireSignin, priceRulesControllers.priceRuleDetails)
router.post("/priceRules", authControllers.requireSignin, priceRulesControllers.priceRuleAdd)
router.put("/priceRules/:id", authControllers.requireSignin, priceRulesControllers.priceRuleUpdate)
router.delete("/priceRules/:ids", authControllers.requireSignin, priceRulesControllers.priceRuleDelete)
...
router.get("/companies", companiesControllers.companiesList)
router.get("/companies/:id", companiesControllers.companyDetails)
router.post("/companies", companiesControllers.companyAdd)
router.put("/companies/:id", companiesControllers.companyUpdate)
